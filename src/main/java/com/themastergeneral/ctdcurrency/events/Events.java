				...
				if (randomInt == 1) {
					...
					if (itemdrop <= 500) {
						ItemStack itemStackToDrop = new ItemStack(
								ModItems.hundredth, 1);
						event.getDrops().add(
								new EntityItem(event.getEntity().worldObj,
						...
						ItemStack itemStackToDrop = new ItemStack(ModItems.one,
								1);
						event.getDrops().add(
								new EntityItem(event.getEntity().worldObj,
										event.getEntity().posX, event
						...
						ItemStack itemStackToDrop = new ItemStack(ModItems.ten,
								1);
						event.getDrops().add(
								new EntityItem(event.getEntity().worldObj,
										event.getEntity().posX, event
