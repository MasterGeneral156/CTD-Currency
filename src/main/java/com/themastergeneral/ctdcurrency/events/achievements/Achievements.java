...
public class Achievements 
{
    ...
    {
		Money1 = new Achievement("achievement.getHundredth", "getHundredth", 0, 0, ModItems.hundredth, null);
	...
	{
		CurrencyPage = new AchievementPage("CTD Currency", Money1, Money2, Money3, Money4, 
